from generator_graph_jira import compiled_graph, AgentState, format_markdown_table_for_display, export_testcases_to_excel, \
    fetch_jira_ticket_description, fetch_jira_ticket
from langchain_core.messages import HumanMessage

print("=== Test Case Generator ===")
ticketNum = input("Paste your JIRA ticket number:\n\n")
jiraTicket = fetch_jira_ticket(ticketNum)
...
if export_choice == 'y':
    ...
    export_testcases_to_excel(testcases, filename, jiraTicket)